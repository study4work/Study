...
Вместо ручного создания фабрик (Factory) или использования switch/case, Spring позволяет внедрить все реализации интерфейса сразу в виде List или Map.
Пример: Обработка платежей (Payment)
У нас есть разные способы оплаты (Карта, PayPal, Криптовалюта). Клиент выбирает способ, а мы делегируем работу конкретной стратегии.
