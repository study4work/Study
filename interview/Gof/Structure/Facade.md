...
**Суть**: Скрывает сложность системы, предоставляя простой унифицированный интерфейс. «Одно окно» для доступа к сложной подсистеме.
**Аналогия из жизни**: Кнопка «Включить все» в умном доме. За ней скрыта сложная система: закрытие штор, включение света, настройка термостата, запуск кофеварки. Но вам не нужно знать, как это работает, вы просто нажимаете одну кнопку.
